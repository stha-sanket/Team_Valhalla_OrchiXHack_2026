...
\begin{figure}[H]\centering
  \includegraphics[width=0.31\textwidth]{screenshot3}\hfill
  \includegraphics[width=0.31\textwidth]{screenshot5}\hfill
  \includegraphics[width=0.31\textwidth]{screenshot8}\\[1em]
  \includegraphics[width=0.31\textwidth]{screenshot6}\hfill
  \includegraphics[width=0.31\textwidth]{screenshot7}\hfill
  \includegraphics[width=0.31\textwidth]{screenshot9}
  \caption{AR Pathfinder: Route selection, live compass guidance, and world-anchored checkpoint media.}\label{fig:screens-ar}
\end{figure}

\begin{figure}[H]\centering
  \includegraphics[width=0.31\textwidth]{screenshot1}\hfill
  \includegraphics[width=0.31\textwidth]{screenshot2}\hfill
  \includegraphics[width=0.31\textwidth]{screenshot12}\\[1em]
  \includegraphics[width=0.31\textwidth]{screenshot4}\hfill
  \includegraphics[width=0.31\textwidth]{screenshot10}\hfill
  \includegraphics[width=0.31\textwidth]{screenshot11}
  \caption{Gamification \& Community: Dashboard, earned badges, profile collections, quizzes, reward redemption, and the public leaderboard.}\label{fig:screens-gamification}
\end{figure}

\begin{figure}[H]\centering
  \includegraphics[width=0.31\textwidth]{screenshot15}\hfill
  \includegraphics[width=0.31\textwidth]{screenshot17}\hfill
  \includegraphics[width=0.31\textwidth]{screenshot18}\\[1em]
  ...
  \caption{Administration \& Settings: Admin analytics, user management, the venue setup tool (waypoint logger), and account settings.}\label{fig:screens-admin}
\end{figure}
